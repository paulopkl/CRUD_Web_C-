...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if(this._context.Department.Any() || this._context.Seller.Any() || this._context.SalesRecord.Any())
            {
                return; // Db has been seeded, stop running of this method
            }
            ...
            this._context.Department.AddRange(d1, d2, d3, d4);

            this._context.Seller.AddRange(s1, s2, s3, s4, s5, s6);
